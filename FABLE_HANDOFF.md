...
Build against `scrimshawlife-ctrl/SUAS-specs` release **v0.1.6**.

- Specs merge: `5074812eff61e22f8932de4c1460bc6d6d37f747`
- Manifest: `RELEASE_MANIFEST-0.1.6.md`
- Decision ledger: inherited unchanged — `RELEASE_DECISIONS-0.1.5.md` (D-012); `RELEASE_DECISIONS-0.1.3.md` (D-018); `RELEASE_DECISIONS-0.1.2.md` (D-017); `RELEASE_DECISIONS-0.1.0.md` otherwise. v0.1.6 closes no D-0xx.
