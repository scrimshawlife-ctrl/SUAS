 ...
 * - SUAS-specs RELEASE_MANIFEST-0.1.4.md "Runtime pins"
...
export const SPEC_VERSION = '0.1.4' as const;

/** Release manifest identifier this build claims. RELEASE_MANIFEST-0.1.4.md. */
export const RELEASE_MANIFEST = 'RELEASE_MANIFEST-0.1.4.md' as const;
 ...
 */
export const SPECS_COMMIT = 'b4baad3fc39af36e22df9fd3bc3f523392f19a2e' as const;

/** Canonical API version selector. API.md §2; unchanged by v0.1.4. */
export const API_VERSION = 'v0' as const;

/** Path prefix for all v0 routes. API.md §2. */
export const API_PREFIX = '/api/v0' as const;

/** Domain event schema version. VERSIONING.md §3.4; unchanged by v0.1.4. */
 ...
 * RELEASE_MANIFEST-0.1.4.md "Readiness boundary"; HANDOFF.md §2.
 */
 ...
 * HANDOFF.md §2, §12; ENVIRONMENT.md §3 rule 4; RELEASE_MANIFEST-0.1.4.md.
 *
