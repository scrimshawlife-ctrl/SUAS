 ...
 * - SUAS-specs RELEASE_MANIFEST-0.1.1.md "Runtime pins"
...
/** Release manifest identifier this build claims. RELEASE_MANIFEST-0.1.1.md. */
export const RELEASE_MANIFEST = 'RELEASE_MANIFEST-0.1.1.md' as const;
 ...
 */
export const SPECS_COMMIT = 'e7aaf5d8ec1f7b646f3fd96866947b40c37f84fb' as const;

/** Canonical API version selector. API.md §2; unchanged by v0.1.1. */
export const API_VERSION = 'v0' as const;

/** Path prefix for all v0 routes. API.md §2. */
export const API_PREFIX = '/api/v0' as const;

/** Domain event schema version. VERSIONING.md §3.4; unchanged by v0.1.1. */
 ...
 * RELEASE_MANIFEST-0.1.1.md "Readiness boundary"; HANDOFF.md §2.
 */
 ...
 * HANDOFF.md §2, §12; ENVIRONMENT.md §3 rule 4; RELEASE_MANIFEST-0.1.1.md.
 *
