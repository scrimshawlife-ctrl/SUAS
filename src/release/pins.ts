 ...
 * - SUAS-specs RELEASE_MANIFEST-0.1.6.md "Runtime pins"
...
export const SPEC_VERSION = '0.1.6' as const;

/** Release manifest identifier this build claims. RELEASE_MANIFEST-0.1.6.md. */
export const RELEASE_MANIFEST = 'RELEASE_MANIFEST-0.1.6.md' as const;
 ...
 */
export const SPECS_COMMIT = '5074812eff61e22f8932de4c1460bc6d6d37f747' as const;

/** Canonical API version selector. API.md §2; unchanged by v0.1.6. */
export const API_VERSION = 'v0' as const;

/** Path prefix for all v0 routes. API.md §2. */
export const API_PREFIX = '/api/v0' as const;

/** Domain event schema version. VERSIONING.md §3.4; unchanged by v0.1.6. */
 ...
 * RELEASE_MANIFEST-0.1.6.md "Readiness boundary"; HANDOFF.md §2.
 */
 ...
 * HANDOFF.md §2, §12; ENVIRONMENT.md §3 rule 4; RELEASE_MANIFEST-0.1.6.md.
 *
