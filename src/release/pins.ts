 ...
 * - SUAS-specs RELEASE_MANIFEST-0.1.5.md "Runtime pins"
...
export const SPEC_VERSION = '0.1.5' as const;

/** Release manifest identifier this build claims. RELEASE_MANIFEST-0.1.5.md. */
export const RELEASE_MANIFEST = 'RELEASE_MANIFEST-0.1.5.md' as const;
 ...
 */
export const SPECS_COMMIT = 'e8a7d4cc4c409ff00fef115a8b3f5cec9f9b5861' as const;

/** Canonical API version selector. API.md §2; unchanged by v0.1.5. */
export const API_VERSION = 'v0' as const;

/** Path prefix for all v0 routes. API.md §2. */
export const API_PREFIX = '/api/v0' as const;

/** Domain event schema version. VERSIONING.md §3.4; unchanged by v0.1.5. */
 ...
 * RELEASE_MANIFEST-0.1.5.md "Readiness boundary"; HANDOFF.md §2.
 */
 ...
 * HANDOFF.md §2, §12; ENVIRONMENT.md §3 rule 4; RELEASE_MANIFEST-0.1.5.md.
 *
